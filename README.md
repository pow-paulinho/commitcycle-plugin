...
The [CommitCycle](https://commitcycle.com) plugin for Claude Code: the `cc`
CLI, the enforcement hook, and the skills that set a repository up.
...
repository by `scripts/publish-plugin.sh`. Version: v0.1.2.
